...
def network_position_score(state, color):
    ...
    for node_id, (bldg_color, bldg_type) in buildings.items():
        ...
        for tile in tiles:
            ...
            # Check robber — zero pips if robber is on this tile
    ...
    # buildable_node_ids calls set().union(*subgraphs); if the player has
    # no roads yet, subgraphs is [] and union(*[]) raises TypeError.
    try:
